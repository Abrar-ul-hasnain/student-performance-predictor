      ...
      <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Designed with ❤️ by Abrar-ul-Hasnain</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <a href="https://github.com/Abrar-ul-hasnain" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg glass flex items-center justify-center text-slate-300 hover:text-white hover:border-cyan-glow/40 transition-colors">
